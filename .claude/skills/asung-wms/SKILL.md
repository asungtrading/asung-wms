...
08-12 의 6건 = Rollback Finalize 오판(513건 노출·실사고 1건) · pallet_items 2517 초과 · admin 배치 카드 과소(33→30 표시) · sku_bins 8배 초과(빈 드롭다운 1481 중 1000만) · Stats All 기간 과소 · 롤백 다운스트림 `.in` 잘림. ⚠️ **팩 대기열 정지는 세지 않았다**(작업자 신고 + 시스템 정지 — 정의 4조건 미충족). 세션 성격 = 캡 전수 조사(깊이 판 세션 — 신규 앵커 정의의 주의 ② 그대로). 정본: `docs/sessions/2026-08-12-hold-and-postgrest-cap.md` 10장.
